...
from .sven_models import GPTBigCodeForPrefix, PhiPrefix, CodeLlamaPrefix, Qwen2Prefix, CodeGenPrefix, MistralPrefix
...
def load_model(model_name, args):
    ...
    if '-lora' in model_name:
        ...
        elif 'mistral' in pretrained_name:
            model_class = MistralPrefix
        elif 'codellama' in pretrained_name:
            model_class = CodeLlamaPrefix
        elif 'deepseek' in pretrained_name:
            model_class = CodeLlamaPrefix
        elif 'qwen2' in pretrained_name:
            model_class = Qwen2Prefix
        elif 'codegen' in pretrained_name:
            model_class = CodeGenPrefix
        else:
