...
class custom_CodeGenForCausalLM(CodeGenPreTrainedModel):
    ...
    def forward(
        ...
        logits_ori, logits_neg, logits_pos = lm_logits
        lm_logits = (logits_ori.to(torch.float32), logits_neg.to(torch.float32), logits_pos.to(torch.float32))
